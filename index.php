<?php
    ...
    if ($detect->isMobile() || $detect->isTablet()) {
        header('Location: http://radio.skaia.net/m');
    }
?>
<!DOCTYPE html>
...
<!--[if gt IE 8]><!--><html class="no-js"><!--<![endif]-->
    <head>
        ...
        <meta property="og:image" content="http://radio.skaia.net/img/base.png">
        <meta property="og:type" content="website">
        <meta property="og:url" content="http://radio.skaia.net/">
        ...
        <meta name="twitter:image" content="http://radio.skaia.net/img/base.png">
    ...
    <body>
        ...
        <div class="container-full" id="header">
            <!-- Album Art -->
            <img src="http://dl.skaia.net/images/albums/disc/3.png" width="124px" height="auto" class="album-art-section" id="album-art">
        ...
        <div class="container-full" id="body">
            <!-- Webchat -->
            <!-- <iframe id="webchat" src="http://skaia.net/chat" scrolling="no" style="width:100%;height:100%;"></iframe> -->
